...
`cawg-trqp-verifier-refimpl` is a Tier 1 flagship repository in the TRQP assurance stack. Its mandate is **reference verifier implementation**. The repository is maintained as executable governance: material claims should map to artifacts, validation, evidence, and a reviewable change record.
...
- implementation profiles and fixtures
- replayable decision and audit evidence

This repository is not authoritative for:

- the TRQP protocol specification
- CAWG or C2PA normative standards
- ecosystem certification decisions

...
description: "How this repository fits into the wider TRQP portfolio adoption journey."
...
`cawg-trqp-verifier-refimpl` provides **reference verifier implementation** and produces **Decision receipt and replayable audit bundle**.

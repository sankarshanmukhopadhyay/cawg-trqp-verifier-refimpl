    ...
    *,
    ...
    replay_inputs = {
        ...
        "privacy": {
            ...
            "sensitivity_class": resolved_privacy.sensitivity_class,
            "retention_class": resolved_privacy.retention_class,
            "redaction_mode": resolved_privacy.redaction_mode,
            "disclosure_audience": resolved_privacy.disclosure_audience,
        },
